...
void MX_TIM1_Init(void)
{
  ...
  htim1.Instance = TIM1;
  htim1.Init.Prescaler = systemCoreClock-1;
  htim1.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim1.Init.Period = stepCounterPeriod-1;
  ...
  sConfigOC.Pulse = stepCounterPeriod/2;
...
void MX_TIM15_Init(void)
{
  ...
  htim15.Init.Prescaler = (systemCoreClock/1000) -1;
...
void MX_TIM16_Init(void)
{
  ...
  htim16.Init.Prescaler = systemCoreClock - 1;
